...
fname=['CAL/calc_pdf_rand_RAND_' num2str(byear+2017) '-' num2str(eyear+2017) '_runmean_20'];
save(fname,'RAND1','RAND2','RAND3','RAND4')

clear RAND1 RAND2 RAND3 RAND4
fname=['CAL/calc_pdf_rand_ALL_' num2str(byear+2017) '-' num2str(eyear+2017) '_runmean_20'];
save(fname)
